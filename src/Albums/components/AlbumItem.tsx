    ...
    const uploadPhotoModal = <Modal isOpen={isUploadModalOpen} onClose={() => setIsUploadModalOpen(false)}>
        ...
        <form onSubmit={uploadPhotoHandler}>
            <div className='flex flex-col space-x-2'>
                ...
                {
                    preview && <div className="flex flex-col items-center">
                         <img src={preview} alt="Preview" className="mt-4 w-64 h-64 object-cover rounded-lg" />
                    </div>
                }
